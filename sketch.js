...
parede = createSprite(150,400,20,120)
parede.rotation = 45
  
parede2 = createSprite(50,450,20,120)
parede2.rotation = 89
...
if(collide(cenoura.body,parede)== true){
  cenoura.shapeColor = 'red'
}
if(collide(cenoura.body,parede2)== true){
  cenoura.shapeColor = 'red'
}
